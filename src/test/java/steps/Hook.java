...
public class Hook extends BaseUtil{
    ...
    public void InitializeTest(Scenario scenario) {
		...
		/*
		 * WebDriverManager.chromedriver().version("79.0").setup(); ChromeOptions
		 ...
		 * options.addArguments("--disable-gpu"); base.Driver = new
		 * ChromeDriver(options); base.Driver.get("https://www.lenstore.co.uk/");
		 */
